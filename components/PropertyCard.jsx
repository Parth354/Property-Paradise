...
const PropertyCard = ({ property }) => {
  const getRateDisplay = () => {
    ...
    else if (rates.nightly) return "$" + rates.nightly + "/night"
    else if (rates.weekly) return "$" + rates.weekly + "/week"
  }
  return (
    <div className="rounded-xl shadow-md relative">
      ...
      <div className="p-4">
        ...
        >
          <p><FaMoneyBill className="fa-solid fa-money-bill"></FaMoneyBill> Nightly</p>
          <p><FaMoneyBill className="fa-solid fa-money-bill"></FaMoneyBill> Weekly</p>
          <p><FaMoneyBill className="fa-solid fa-money-bill"></FaMoneyBill> Monthly</p>
        </div>
