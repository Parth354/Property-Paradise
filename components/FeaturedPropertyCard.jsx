    ...
    return (
        ...
        >
            ...
            <div className="p-6">
                ...
                >
                    {property.rates.monthly ? ('$'+ property.rates.monthly +"/mon" ):('$'+ property.rates.weekly +"/mon" )}
                </h3>
                <div className="flex justify-center gap-4 text-gray-500 mb-4">
                    <p>
                        <FaBed className="fa-solid "></FaBed> {property.beds}
                        <span className="md:hidden lg:inline">Beds</span>
                    </p>
                    <p>
                        <FaBath className="fa-solid "></FaBath> {property.baths}
                ...
                >
                    <p><FaMoneyBill className="fa-solid "></FaMoneyBill> Nightly</p>
                    <p><FaMoneyBill className="fa-solid "></FaMoneyBill> Weekly</p>
                </div>
                ...
                <div className="flex flex-col lg:flex-row justify-between">
                    <div className="flex align-middle gap-2 mb-4 lg:mb-0">
                        <FaLocationArrow
                            className="fa-solid text-lg text-orange-700"
                        ></FaLocationArrow>
