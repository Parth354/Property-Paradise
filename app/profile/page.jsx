...
const ProfilePage = () => {
    ...
    const handleDeleteProperty=async(propertyId)=>{
        ...
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_DOMAIN}/properties/${propertyId}`,{method:'DELETE'})
            if(res.status===200){
            ...
            {loading? (<Spinner loading={loading}/>): (
                properties.map((property)=>(
                    ...
                    <div className="mt-2">
                      ...
                      <p className="text-gray-600">Address: {property.location.state} {property.location.city}</p>
                    </div>
                    <div className="mt-2">
